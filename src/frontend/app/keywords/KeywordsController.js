...
(function() {
  ...
  app.controller('KeywordsController', function($scope, RepositoryFactory, resolveEntity) {
    ...
    load all keyword categories and keywords from the API */
    ...
    /* These functions are called when the front end is operated, e.g., if a button is clicked */
